        ...
        >
          {projects.map((project, index) => (
            <motion.div
              ...
              className="bg-white rounded-lg shadow-lg overflow-hidden h-[30rem] relative group project-card mx-auto"
              ...
              <div className="relative w-full h-full">
                ...
                <div className="absolute top-[85%] left-0 w-full h-full bg-white/90 flex flex-col transition-all duration-300 group-hover:top-[25%]">
                  <div className="flex justify-between items-center h-[4.5rem] w-full px-4 bg-[#ffd900]">
                    <h3 className="text-lg md:text-xl lg:text-2xl font-bold line-clamp-2">{project.name}</h3>
                  </div>
                  
                  <div className="p-4 lg:p-8 flex flex-col justify-center flex-1">
                    <p className="text-sm md:text-base lg:text-lg mb-4 lg:mb-8 line-clamp-3">{project.desc}</p>
